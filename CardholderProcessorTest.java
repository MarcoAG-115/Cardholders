...
public class CardholderProcessorTest {
   ...
   @Test public void getInvalidRecordsArrayTest() 
   {
      ...
      CardholderProcessor obj = new CardholderProcessor();
      obj.addInvalidRecord("1;10005;Smith, Pam;110p.0;200.0;34.5"
                           + ";100.0;63.50;350.0 *** "
      ...
      throws FileNotFoundException
   {
      ...
      bdc2.setPayment(1400.00);
      bdc2.setPrevBalance(1400.0);
      
      Assert.assertEquals(true, bdc2.equals(test[0]));
   }
